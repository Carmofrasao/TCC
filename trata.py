...
for _, _, arquivos in os.walk('./wordpress/logs/normal/sysdig'):
    for arquivo in arquivos:
        ...
        # with open(f'./wordpress/logs/normal/sysdig/{arquivo}', "w") as f:
        #     for line in lines:
        #         e_sys = 0
        #         linhaAux = line.split(' ')
        #         call = linhaAux[8]
